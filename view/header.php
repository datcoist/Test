                ...
                <div class="content-topbar flex-sb-m h-full container">
                    ...
                    <div class="right-top-bar flex-w h-full">
                        ...
                        <a href="#" class="flex-c-m trans-04 p-lr-25">
                            Chào:
                            <?php
                                extract($_SESSION["coi"]);
                                echo $ho_ten;
                                ?>
                        </a>
                        <?php } ?>
                        <a onclick="return confirm('Bạn có chắc chắn muốn đăng xuất hay không?')"
                            class="flex-c-m trans-04 p-lr-25" href="./login/logout.php">Đăng xuất</a>
